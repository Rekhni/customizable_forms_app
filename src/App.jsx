  ...
  return (
    <Router>
      ...
      <div className={`${isDark ? 'bg-theme-dark' : 'bg-theme-light'}`} style={{ minHeight: '100vh' }}>
        <Routes>
          <Route path="/" element={<Dashboard isDark={isDark} lang={language} />} />
          ...
          <Route path="/template/:id/preview" element={<ViewTemplate isDark={isDark} lang={language}/>}/>
          ...
          <Route path="/filled-forms/:formId" element={<PrivateRoute><FormDetails isDark={isDark} lang={language} /></PrivateRoute>}/>
        </Routes>
      </div>
    </Router>
  )
